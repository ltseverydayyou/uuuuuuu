...
SwitchButtonLit.BackgroundTransparency = 1;
...
SwitchButtonActivator.BackgroundTransparency = 1;
...
SwitchButtonActivator.TextSize = 12;
...
SwitchButtonLit_2.BackgroundTransparency = 1;
...
SwitchButtonActivator_2.BackgroundTransparency = 1;
...
SwitchButtonActivator_2.TextSize = 12;
...
SwitchButtonLit_3.BackgroundTransparency = 1;
...
SwitchButtonActivator_3.BackgroundTransparency = 1;
...
SwitchButtonActivator_3.TextSize = 12;
...
SwitchButtonLit_4.BackgroundTransparency = 1;
...
SwitchButtonActivator_4.BackgroundTransparency = 1;
...
SwitchButtonActivator_4.TextSize = 12;
...
SwitchButtonActivator_5.BackgroundTransparency = 1;
...
SwitchButtonActivator_5.TextSize = 14;
...
SwitchButtonActivator_6.BackgroundTransparency = 1;
...
SwitchButtonActivator_6.TextSize = 14;
...
SwitchButtonActivator_7.BackgroundTransparency = 1;
...
SwitchButtonActivator_7.TextSize = 14;
...
Menu_2.BackgroundTransparency = 1;
...
local function DIPONU_fake_script()
	...
	local time = 0.5;
	local SwitchButtonFade = TweenService:Create(script.Parent.SwitchButton, TweenInfo.new(time), {
		BackgroundTransparency = 0
	});
	local SwitchButtonFadeOut = TweenService:Create(script.Parent.SwitchButton, TweenInfo.new(time), {
		BackgroundTransparency = 1
	});
	local SwitchButtonLitFade = TweenService:Create(script.Parent.SwitchButton.SwitchButtonLit, TweenInfo.new(time), {
		BackgroundTransparency = 0
	});
	local SwitchButtonLitFadeOut = TweenService:Create(script.Parent.SwitchButton.SwitchButtonLit, TweenInfo.new(time), {
		BackgroundTransparency = 1
	});
	local Toggle = false;
	script.Parent.SwitchButtonActivator.MouseButton1Click:connect(function()
		if flying == false then
			...
			repeat
				wait();
			until lplayer and lplayer.Character and lplayer.Character:FindFirstChild("HumanoidRootPart") and lplayer.Character:FindFirstChild("Humanoid");
			repeat
				wait();
			until Mouse;
...
local function UOOREXU_fake_script()
...
local function EGFWXE_fake_script()
	local script = Instance.new("LocalScript", Page1);
	local gui_hide_button = {
	...
	local teambasedswitch = "u";
	local presskeytoaim = true;
	local aimkey = "e";
	aimbothider = false;
	aimbothiderspeed = 0.5;
						...
						local function gg(plr)
							pcall(function()
								if plr.Name ~= lplr.Name and plr.Character and plr.Character.Humanoid and plr.Character.Humanoid.Health > 0 and plr.Character.Head then
									...
									local obj, pos = (ClonedService("Workspace")):FindPartOnRayWithIgnoreList(r1, {
										lplr.Character.Head
									});
...
local function UBACA_fake_script()
	...
	function MakeESP()
		if ESPToggle == true then
			for _, v in pairs((game:FindFirstChildWhichIsA("Players")):GetChildren()) do
...
local function YNNKEQ_fake_script()
...
local function QQOZMVW_fake_script()
...
local function SVWBPQ_fake_script()
...
local function XXBWPH_fake_script()
...
local function OTKOWZS_fake_script()
	local script = Instance.new("LocalScript", MainFrame);
	wait(2);
