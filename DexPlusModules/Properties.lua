...
local function main()
	...
	Properties.NewPropEntry = function(index)
		...
		local c = newCheckbox.OnInput:Connect(function()
		...
		addCon(nameFrame.Expand.InputBegan:Connect(function(input)
			local prop = viewList[index + Properties.Index]
		...
		addCon(nameFrame.Expand.InputEnded:Connect(function(input)
			local prop = viewList[index + Properties.Index]
			if not prop or input.UserInputType ~= Enum.UserInputType.MouseMovement then
				return
			end
		...
		addCon(nameFrame.Expand.MouseButton1Down:Connect(function()
			local prop = viewList[index + Properties.Index]
			if not prop then
				return
			end
		...
		addCon(nameFrame.PropName.InputBegan:Connect(function(input)
			local prop = viewList[index + Properties.Index]
			if not prop then
				return
			end
		...
		addCon(nameFrame.PropName.InputEnded:Connect(function(input)
		...
		addCon(valueFrame.ValueBox.MouseButton1Down:Connect(function()
			local prop = viewList[index + Properties.Index]
			if not prop then
				return
			end
		...
		addCon(valueFrame.ColorButton.MouseButton1Down:Connect(function()
			local prop = viewList[index + Properties.Index]
			if not prop then
				return
			end
		...
		addCon(valueFrame.RightButton.MouseButton1Click:Connect(function()
			local prop = viewList[index + Properties.Index]
			if not prop then
				return
			end
		...
		addCon(nameFrame.ToggleAttributes.MouseButton1Click:Connect(function()
			Settings.Properties.ShowAttributes = not Settings.Properties.ShowAttributes
			Properties.ShowExplorerProps()
		end))

		addCon(newEntry.RowButton.MouseButton1Click:Connect(function()
			Properties.DisplayAddAttributeWindow()
		end))

		addCon(newEntry.EditAttributeButton.MouseButton1Down:Connect(function()
			local prop = viewList[index + Properties.Index]
			if not prop then
				return
			end
		...
		addCon(valueFrame.SoundPreview.ControlButton.MouseButton1Click:Connect(function()
		...
		addCon(valueFrame.SoundPreview.InputBegan:Connect(function(input)
			if input.UserInputType ~= Enum.UserInputType.MouseButton1 then
				return
			end

			local releaseEvent, mouseEvent
			releaseEvent = addCon(service.UserInputService.InputEnded:Connect(function(input)
				if input.UserInputType ~= Enum.UserInputType.MouseButton1 then
					return
				end
				disc(releaseEvent)
			...
			mouseEvent = addCon(service.UserInputService.InputChanged:Connect(function(input)
	...
	Properties.SetSoundPreview = function(soundObj, noplay)
		...
		if not sound then
			...
			sound.Name = "Preview"
			addWinCon(sound.Paused:Connect(function()
			...
			addWinCon(sound.Resumed:Connect(function()
				Properties.Refresh()
			end))
			addWinCon(sound.Ended:Connect(function()
				local entry = Properties.GetSoundPreviewEntry()
				if entry then
		...
		if not soundObj then
			...
			coroutine.wrap(function()
				...
				while Properties.SoundPreviewTime == pt do
					...
					local okPlay, playing = pcall(function()
						return snd.Playing
					end)
	...
	Properties.InitInputBox = function()
		...
		addWinCon(inputTextBox.FocusLost:Connect(function()
		...
		addWinCon(inputTextBox.Focused:Connect(function()
	...
	Properties.InitSearch = function()
		...
		addWinCon(searchBox:GetPropertyChangedSignal("Text"):Connect(function()
	...
	Properties.Init = function()
		...
		winCons[#winCons + 1] = window.GuiElems.Main:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
		...
		winCons[#winCons + 1] = window.OnActivate:Connect(function()
			Properties.UpdateView()
			Properties.Update()
			Properties.Refresh()
		end)

		winCons[#winCons + 1] = window.OnRestore:Connect(function()
			Properties.UpdateView()
			Properties.Update()
			Properties.Refresh()
		end)
		...
		addWinCon(scrollV.Scrolled:Connect(function()
			Properties.Index = scrollV.Index
			Properties.Refresh()
		end))
		...
		addWinCon(scrollH.Scrolled:Connect(function()
			Properties.Refresh()
		end))
