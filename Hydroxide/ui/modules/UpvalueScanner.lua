...
local Assets = import("ui/MainAssets").UpvalueScanner
...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/ltseverydayyou/uuuuuuu/tree/main/Hydroxide

local auxSource = (game.HttpGet and game:HttpGet("https://raw.githubusercontent.com/ltseverydayyou/uuuuuuu/main/Hydroxide/ohaux.lua")) or game:HttpGetAsync("https://raw.githubusercontent.com/ltseverydayyou/uuuuuuu/main/Hydroxide/ohaux.lua")
local aux = loadstring(auxSource)()
