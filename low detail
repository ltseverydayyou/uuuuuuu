...
local Players, Lighting, StarterGui, MaterialService = ClonedService("Players"), ClonedService("Lighting"), ClonedService("StarterGui"), ClonedService("MaterialService");
local ME, CanBeEnabled = Players.LocalPlayer, {
	"ParticleEmitter",
	"Trail",
	"Smoke",
	"Fire",
...
local Descendants = game:QueryDescendants("Instance");
local StartNumber = _G.WaitPerAmount or 500;
local WaitNumber = _G.WaitPerAmount or 500;
if _G.SendNotifications then
	StarterGui:SetCore("SendNotification", {
		Title = "Checking",
		Text = "" .. #Descendants .. " Instances...",
		Duration = 15,
		Button1 = "Okay"
	});
end;
