...
task.spawn(function()
	pcall(function()
		...
		ByfronLogo.BackgroundTransparency = 1;
		...
		TitleReason.BackgroundTransparency = 1;
		...
		TitleReason_2.BackgroundTransparency = 1;
		...
		DescriptionReason_2.TextSize = 12;
		...
		local Success, Result = pcall(function()
			Canvas.Parent = __lt.cs("CoreGui", cloneref);
		end);
		if not Success then
