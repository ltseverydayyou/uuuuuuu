...
local function createOptionHolder(holderTitle, parent, parentTable, subHolder)
	...
	closeHolder.InputBegan:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			...
			(__lt.cm("TweenService", "Create", close, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				Rotation = parentTable.open and 90 or 180,
				ImageColor3 = parentTable.open and Color3.fromRGB(50, 50, 50) or Color3.fromRGB(30, 30, 30)
			})):Play();
			if subHolder then
				(__lt.cm("TweenService", "Create", title, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					BackgroundColor3 = parentTable.open and Color3.fromRGB(16, 16, 16) or Color3.fromRGB(10, 10, 10)
				})):Play();
			else
				(__lt.cm("TweenService", "Create", round, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
...
function createToggle(option, parent)
	...
	main.InputBegan:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			...
			if not option.state then
				(__lt.cm("TweenService", "Create", tickboxOutline, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
	...
	function option:SetState(state)
		...
		(__lt.cm("TweenService", "Create", tickboxInner, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			ImageColor3 = state and Color3.fromRGB(255, 65, 65) or Color3.fromRGB(20, 20, 20)
		})):Play();
		if state then
			(__lt.cm("TweenService", "Create", tickboxOutline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				ImageColor3 = Color3.fromRGB(255, 65, 65)
			})):Play();
		elseif inContact then
			(__lt.cm("TweenService", "Create", tickboxOutline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				ImageColor3 = Color3.fromRGB(140, 140, 140)
			})):Play();
		else
...
function createButton(option, parent)
	...
	main.InputBegan:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true;
			(__lt.cm("TweenService", "Create", round, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
...
local function createBind(option, parent)
	...
	local round = library:Create("ImageLabel", {
		Position = UDim2.new(1, -6, 0, 4),
		Size = UDim2.new(0, (-(__lt.cm("TextService", "GetTextSize", text, 16, Enum.Font.Gotham, Vector2.new(9000000000, 9000000000))).X) - 16, 1, -10),
		SizeConstraint = Enum.SizeConstraint.RelativeYY,
		BackgroundTransparency = 1,
		Image = "rbxassetid://3570695787",
		ImageColor3 = Color3.fromRGB(40, 40, 40),
	...
	function option:SetKey(key)
		...
		(__lt.cm("TweenService", "Create", round, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			ImageColor3 = inContact and Color3.fromRGB(60, 60, 60) or Color3.fromRGB(40, 40, 40)
		})):Play();
		round.Size = UDim2.new(0, (-(__lt.cm("TextService", "GetTextSize", bindinput.Text, 15, Enum.Font.Gotham, Vector2.new(9000000000, 9000000000))).X) - 16, 1, -10);
	end;
end;
local function createSlider(option, parent)
	...
	main.InputBegan:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			(__lt.cm("TweenService", "Create", fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				ImageColor3 = Color3.fromRGB(255, 65, 65)
			})):Play();
			(__lt.cm("TweenService", "Create", circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
...
local function createList(option, parent, holder)
	...
	round.InputBegan:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			...
			(__lt.cm("TweenService", "Create", option.mainHolder, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
				ImageTransparency = 0,
				Position = UDim2.new(0, position.X - 5, 0, position.Y - 4)
			})):Play();
			(__lt.cm("TweenService", "Create", option.mainHolder, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out, 0, false, 0.1), {
				Position = UDim2.new(0, position.X - 5, 0, position.Y + 1)
			})):Play();
			for _, label in next, content:GetChildren() do
				if label:IsA("TextLabel") then
					(__lt.cm("TweenService", "Create", label, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
	...
	function option:AddValue(value)
		...
		label.InputBegan:connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseButton1 then
				clicking = true;
				(__lt.cm("TweenService", "Create", label, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					BackgroundColor3 = Color3.fromRGB(10, 10, 10)
				})):Play();
				self:SetValue(value);
			end;
			if input.UserInputType == Enum.UserInputType.MouseMovement then
				inContact = true;
				if not clicking then
					(__lt.cm("TweenService", "Create", label, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		...
		label.InputEnded:connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseButton1 then
				clicking = false;
				(__lt.cm("TweenService", "Create", label, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					BackgroundColor3 = inContact and Color3.fromRGB(20, 20, 20) or Color3.fromRGB(30, 30, 30)
				})):Play();
			end;
			if input.UserInputType == Enum.UserInputType.MouseMovement then
				inContact = false;
	...
	function option:Close()
		...
		(__lt.cm("TweenService", "Create", self.mainHolder, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			ImageTransparency = 1,
			Position = UDim2.new(0, position.X - 5, 0, position.Y - 10)
		})):Play();
		for _, label in next, content:GetChildren() do
			if label:IsA("TextLabel") then
				(__lt.cm("TweenService", "Create", label, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					BackgroundTransparency = 1,
					TextTransparency = 1
				})):Play();
			end;
...
local function createBox(option, parent)
	...
	main.InputBegan:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true;
			if not focused then
				(__lt.cm("TweenService", "Create", outline, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					ImageColor3 = Color3.fromRGB(100, 100, 100)
				})):Play();
			end;
		end;
	...
	inputvalue.Focused:connect(function()
		focused = true;
		(__lt.cm("TweenService", "Create", outline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			ImageColor3 = Color3.fromRGB(255, 65, 65)
		})):Play();
	end);
...
local function createColorPickerWindow(option)
	...
	option.resetColor.InputBegan:connect(function(Input)
		...
		if Input.UserInputType == Enum.UserInputType.MouseMovement and (not dragging) then
			(__lt.cm("TweenService", "Create", option.resetColor, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
	...
	option.undoColor.InputBegan:connect(function(Input)
		...
		if Input.UserInputType == Enum.UserInputType.MouseMovement and (not dragging) then
			(__lt.cm("TweenService", "Create", option.undoColor, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				ImageColor3 = Color3.fromRGB(10, 10, 10)
			})):Play();
		end;
	end);
	...
	option.setColor.InputBegan:connect(function(Input)
		...
		if Input.UserInputType == Enum.UserInputType.MouseMovement and (not dragging) then
			(__lt.cm("TweenService", "Create", option.setColor, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				ImageColor3 = Color3.fromRGB(10, 10, 10)
			})):Play();
		end;
	end);
	...
	option.rainbow.InputBegan:connect(function(Input)
		...
		if Input.UserInputType == Enum.UserInputType.MouseMovement and (not dragging) then
			(__lt.cm("TweenService", "Create", option.rainbow, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				ImageColor3 = Color3.fromRGB(10, 10, 10)
			})):Play();
		end;
	end);
...
local function createColor(option, parent, holder)
	...
	option.main.InputBegan:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			...
			(__lt.cm("TweenService", "Create", option.satval, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
				BackgroundTransparency = 0
			})):Play();
			for _, object in next, option.mainHolder:QueryDescendants("Instance") do
				if object:IsA("TextLabel") then
					(__lt.cm("TweenService", "Create", object, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						TextTransparency = 0
					})):Play();
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true;
			if not option.open then
				(__lt.cm("TweenService", "Create", colorBoxOutline, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					ImageColor3 = Color3.fromRGB(140, 140, 140)
				})):Play();
			end;
		end;
	...
	function option:Close()
		...
		(__lt.cm("TweenService", "Create", self.satval, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
			BackgroundTransparency = 1
		})):Play();
		for _, object in next, self.mainHolder:QueryDescendants("Instance") do
			if object:IsA("TextLabel") then
				(__lt.cm("TweenService", "Create", object, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					TextTransparency = 1
				})):Play();
...
function library:Init()
	...
	if syn and syn.protect_gui then
		...
		self.base.Parent = ClonedService("CoreGui");
...
inputService.InputChanged:connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseMovement and library.cursor then
		local mouse = __lt.cm("UserInputService", "GetMouseLocation") + Vector2.new(0, (-36));
